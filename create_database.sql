...
UPDATE tracks SET mood = 'active' WHERE name = 'Empire State of Mind';
UPDATE tracks SET mood = 'active' WHERE name = '99 Problems';
UPDATE tracks SET mood = 'sad' WHERE name = 'Hard Knock Life';
UPDATE tracks SET mood = 'active' WHERE name = 'Holy Grail';
UPDATE tracks SET mood = 'active' WHERE name = 'Run This Town';
UPDATE tracks SET mood = 'active' WHERE name = 'Lose Yourself';
UPDATE tracks SET mood = 'funny' WHERE name = 'The Real Slim Shady';
UPDATE tracks SET mood = 'funny' WHERE name = 'Without Me';
UPDATE tracks SET mood = 'active' WHERE name = 'Rap God';
UPDATE tracks SET mood = 'sad' WHERE name = 'Stan';
UPDATE tracks SET mood = 'active' WHERE name = 'Stronger';
UPDATE tracks SET mood = 'funny' WHERE name = 'Gold Digger';
UPDATE tracks SET mood = 'sad' WHERE name = 'Heartless';
UPDATE tracks SET mood = 'active' WHERE name = 'All of the Lights';
UPDATE tracks SET mood = 'sad' WHERE name = 'Runaway';
UPDATE tracks SET mood = 'funny' WHERE name = 'Super Bass';
UPDATE tracks SET mood = 'funny' WHERE name = 'Starships';
UPDATE tracks SET mood = 'funny' WHERE name = 'Anaconda';
UPDATE tracks SET mood = 'funny' WHERE name = 'Pound the Alarm';
UPDATE tracks SET mood = 'funny' WHERE name = 'Bang Bang';
UPDATE tracks SET mood = 'active' WHERE name = 'HUMBLE.';
UPDATE tracks SET mood = 'active' WHERE name = 'Alright';
UPDATE tracks SET mood = 'active' WHERE name = 'King Kunta';
UPDATE tracks SET mood = 'sad' WHERE name = 'Swimming Pools (Drank)';
UPDATE tracks SET mood = 'active' WHERE name = 'DNA.';
UPDATE tracks SET mood = 'calm' WHERE name = 'Love Story';
UPDATE tracks SET mood = 'funny' WHERE name = 'Shake It Off';
UPDATE tracks SET mood = 'funny' WHERE name = 'Blank Space';
UPDATE tracks SET mood = 'funny' WHERE name = 'You Belong With Me';
UPDATE tracks SET mood = 'sad' WHERE name = 'I Knew You Were Trouble';
UPDATE tracks SET mood = 'funny' WHERE name = 'Thank U, Next';
UPDATE tracks SET mood = 'funny' WHERE name = '7 Rings';
UPDATE tracks SET mood = 'funny' WHERE name = 'Problem';
UPDATE tracks SET mood = 'funny' WHERE name = 'Into You';
UPDATE tracks SET mood = 'funny' WHERE name = 'No Tears Left to Cry';
UPDATE tracks SET mood = 'funny' WHERE name = 'Shape of You';
UPDATE tracks SET mood = 'calm' WHERE name = 'Thinking Out Loud';
UPDATE tracks SET mood = 'calm' WHERE name = 'Perfect';
UPDATE tracks SET mood = 'calm' WHERE name = 'Photograph';
UPDATE tracks SET mood = 'active' WHERE name = 'Castle on the Hill';
UPDATE tracks SET mood = 'funny' WHERE name = 'Like a Virgin';
UPDATE tracks SET mood = 'funny' WHERE name = 'Like a Prayer';
UPDATE tracks SET mood = 'funny' WHERE name = 'Material Girl';
UPDATE tracks SET mood = 'funny' WHERE name = 'Vogue';
UPDATE tracks SET mood = 'funny' WHERE name = 'Hung Up';
UPDATE tracks SET mood = 'active' WHERE name = 'Bad Romance';
UPDATE tracks SET mood = 'active' WHERE name = 'Poker Face';
UPDATE tracks SET mood = 'funny' WHERE name = 'Born This Way';
UPDATE tracks SET mood = 'calm' WHERE name = 'Shallow';
UPDATE tracks SET mood = 'funny' WHERE name = 'Just Dance';
UPDATE tracks SET mood = 'calm' WHERE name = 'Angie';
UPDATE tracks SET mood = 'active' WHERE name = 'Sympathy for the Devil';
UPDATE tracks SET mood = 'funny' WHERE name = 'Miss You';
UPDATE tracks SET mood = 'sad' WHERE name = 'Wild Horses';
UPDATE tracks SET mood = 'calm' WHERE name = 'You Can''t Always Get What You Want';
UPDATE tracks SET mood = 'calm' WHERE name = 'Everlong';
UPDATE tracks SET mood = 'active' WHERE name = 'The Pretender';
UPDATE tracks SET mood = 'active' WHERE name = 'Learn to Fly';
UPDATE tracks SET mood = 'active' WHERE name = 'Best of You';
UPDATE tracks SET mood = 'active' WHERE name = 'Times Like These';
UPDATE tracks SET mood = 'active' WHERE name = 'Basket Case';
UPDATE tracks SET mood = 'active' WHERE name = 'American Idiot';
UPDATE tracks SET mood = 'sad' WHERE name = 'Wake Me Up When September Ends';
UPDATE tracks SET mood = 'calm' WHERE name = 'Good Riddance (Time of Your Life)';
UPDATE tracks SET mood = 'sad' WHERE name = 'Boulevard of Broken Dreams';
UPDATE tracks SET mood = 'sad' WHERE name = 'In the End';
UPDATE tracks SET mood = 'calm' WHERE name = 'Numb';
UPDATE tracks SET mood = 'sad' WHERE name = 'Crawling';
UPDATE tracks SET mood = 'active' WHERE name = 'One Step Closer';
UPDATE tracks SET mood = 'sad' WHERE name = 'Breaking the Habit';
UPDATE tracks SET mood = 'calm' WHERE name = 'With or Without You';
UPDATE tracks SET mood = 'calm' WHERE name = 'I Still Haven''t Found What I''m Looking For';
UPDATE tracks SET mood = 'calm' WHERE name = 'One';
UPDATE tracks SET mood = 'active' WHERE name = 'Beautiful Day';
UPDATE tracks SET mood = 'active' WHERE name = 'Sunday Bloody Sunday';
UPDATE tracks SET mood = 'active' WHERE name = 'Wake Me Up';
UPDATE tracks SET mood = 'active' WHERE name = 'Levels';
UPDATE tracks SET mood = 'active' WHERE name = 'The Nights';
UPDATE tracks SET mood = 'active' WHERE name = 'Waiting for Love';
UPDATE tracks SET mood = 'active' WHERE name = 'Hey Brother';
UPDATE tracks SET mood = 'active' WHERE name = 'Red Lights';
UPDATE tracks SET mood = 'active' WHERE name = 'The Business';
UPDATE tracks SET mood = 'funny' WHERE name = 'Jackie Chan';
UPDATE tracks SET mood = 'calm' WHERE name = 'Secrets';
UPDATE tracks SET mood = 'active' WHERE name = 'Ritual';
UPDATE tracks SET mood = 'active' WHERE name = 'Titanium';
UPDATE tracks SET mood = 'calm' WHERE name = 'Without You';
UPDATE tracks SET mood = 'funny' WHERE name = 'Hey Mama';
UPDATE tracks SET mood = 'funny' WHERE name = 'Sexy Bitch';
UPDATE tracks SET mood = 'active' WHERE name = 'Play Hard';
UPDATE tracks SET mood = 'active' WHERE name = 'Ghosts ''n'' Stuff';
UPDATE tracks SET mood = 'calm' WHERE name = 'Strobe';
UPDATE tracks SET mood = 'calm' WHERE name = 'I Remember';
UPDATE tracks SET mood = 'sad' WHERE name = 'Raise Your Weapon';
UPDATE tracks SET mood = 'calm' WHERE name = 'The Veldt';
UPDATE tracks SET mood = 'active' WHERE name = 'Summer';
UPDATE tracks SET mood = 'funny' WHERE name = 'Feel So Close';
UPDATE tracks SET mood = 'active' WHERE name = 'This Is What You Came For';
UPDATE tracks SET mood = 'active' WHERE name = 'Outside';
UPDATE tracks SET mood = 'calm' WHERE name = 'How Deep Is Your Love';
