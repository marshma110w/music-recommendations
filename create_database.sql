...
UPDATE tracks SET mood = 'грустное' WHERE name IN ('The Thrill Is Gone', 'Love in Vain', 'Hurt', 'No Woman, No Cry', 'Redemption Song');
UPDATE tracks SET mood = 'бодрое' WHERE name IN ('Every Day I Have the Blues', 'Rock Me Baby', "Payin' the Cost to Be the Boss", 'Got My Mojo Working', "Rollin' Stone", 'Cross Road Blues', 'Mannish Boy', 'Traveling Riverside Blues', 'Boom Boom', 'One Bourbon, One Scotch, One Beer', 'Boogie Chillen', 'Dimples', "Crawlin' King Snake", 'Smokestack Lightnin', 'I Walk the Line', 'Friends in Low Places', 'The Thunder Rolls', 'The Dance', 'If Tomorrow Never Comes');
UPDATE tracks SET mood = 'спокойное' WHERE name IN ('Sweet Little Angel', 'Blue in Green', 'Giant Steps', 'Blue Train', 'Summertime', 'Dream a Little Dream of Me', 'La Vie En Rose', 'When the Saints Go Marching In', 'Always on My Mind', 'Three Little Birds');
UPDATE tracks SET mood = 'веселое' WHERE name IN ('Hoochie Coochie Man', 'Impressions', "Now's the Time", 'Yardbird Suite', 'Anthropology', 'A-Tisket, A-Tasket', 'Hello, Dolly!', 'Ring of Fire', 'A Boy Named Sue', 'Jolene', '9 to 5', 'Blue Eyes Crying in the Rain', "Mammas Don't Let Your Babies Grow Up to Be Cowboys", 'Shameless', 'What a Wonderful World', 'One Love', 'Legalize It', 'Get Up, Stand Up (with Bob Marley)');

UPDATE tracks SET mood = 'спокойное' WHERE name IN ('Equal Rights', 'Stepping Razor', 'Bush Doctor', 'Blackheart Man', 'Dreamland', 'Cool Runnings', 'Bald Head Jesus', 'Rise and Shine', 'Many Rivers to Cross', 'I Can See Clearly Now', 'Sitting in Limbo', 'Pressure Drop', "54-46 That's My Number", 'Funky Kingston', 'Monkey Man', 'Reggae Got Soul');
UPDATE tracks SET mood = 'веселое' WHERE name IN ("Stayin' Alive", 'Night Fever', 'More Than a Woman', 'You Should Be Dancing', 'Hot Stuff', 'Last Dance', 'Love to Love You Baby', 'MacArthur Park', 'Dancing Queen', 'Mamma Mia', 'Waterloo', 'Fernando', 'Take a Chance on Me', 'I Want Your Love', 'Le Freak', 'Good Times', 'Everybody Dance', 'Get Up (I Feel Like Being a) Sex Machine', "Papa's Got a Brand New Bag", 'I Got You (I Feel Good)', 'Give Up the Funk (Tear the Roof Off the Sucker)', 'Atomic Dog', 'One Nation Under a Groove', 'Mothership Connection', 'Everyday People', 'Thank You (Falettinme Be Mice Elf Agin)', 'Dance to the Music', 'Family Affair', 'Hot Fun in the Summertime', 'September', 'Boogie Wonderland', 'Got to Get You into My Life', 'Celebration', "Ladies' Night", 'Jungle Boogie', 'Get Down On It', 'Fresh', 'Wipe Out', "Walk, Don't Run", 'Hawaii Five-O', 'Pipeline', 'Tequila', 'Green Onions', 'Time Is Tight', 'Soul Limbo', "Hang 'Em High", 'Melting Pot');
UPDATE tracks SET mood = 'бодрое' WHERE name IN ('Got My Mojo Working', "Rollin' Stone", 'Cross Road Blues', 'The Harder They Come', 'How Deep Is Your Love', 'Love to Love You Baby', 'Take a Chance on Me', 'I Will Survive', 'Never Can Say Goodbye', 'I Am What I Am', "Reach Out, I'll Be There", 'Let Me Know (I Have a Right)', 'I Want Your Love', 'My Forbidden Lover', 'Summer Song', 'Time Is Tight', 'Bad Horsie');
UPDATE tracks SET mood = 'грустное' WHERE name IN ('The Thrill Is Gone', 'Sweet Little Angel', 'Love in Vain', 'Night Fever');
